    ...
    <>
      ...
      {!bigLoader && (
        <div className="min-w-screen min-h-screen bg-white p-4">
          <div className="bg-[#1890FF] rounded-t-[1rem] rounded-bl-[1rem] min-w-full py-5 px-[40px]">
            <div className="flex items-center justify-between px-[30px] bg-white rounded-[1rem] py-2 mb-12">
              ...
              <div className="flex items-center w-[150px] justify-between">
                ...
                <Link href="#">
                  <span className="text-[#1890FF] text-[14px]">Solutions</span>
                </Link>
              </div>

              <div>
                <Button className="!bg-[#1891fe] !rounded-[.5rem] !text-white !mt-0 !py-2 !px-4 !font-medium">
                  Get started
                </Button>
              </div>
            </div>
            ...
            <div className="">
              ...
              <span className="text-white mb-6 font-light block">
                With all your DAO members, tools and communication in <br/> one place,
                your DAO can now be more productive than ever.
              </span>

              <Button className="!bg-[#387CF7] !border-solid !border-white !border-[2px] !mb-5 !rounded-[.5rem] !text-white !mt-0 !py-3 !px-4 !font-medium !capitalize">
                Get started
              </Button>
