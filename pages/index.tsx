...
import { IndexContextProps } from "../app/components/types";
import { IndexContext } from "../app/contexts/IndexContext";
...
const Homepage = () => {
  ...
  return (
    <>
      <Head>
        <title>CloverSuite - Seamless collaboration for DAOs</title>
        <meta
          name="description"
          content="CloverSuite is the easiest way to collaborate within a DAO. Enjoy DAO wide chats, calls, proposals and shared storage, at once."
        />
            ...
            <div className="flex items-center w-full">
              <div className="max-w-[586px] relative z-[9]">
                ...
                <p className="block mb-6 font-[400] text-[15px] text-white">
                  Easy communication, collaboration and foster community
                  engagement within your decentralized autonomous organization.
                </p>
                <Button
          ...
          <section className="mt-10 bg-[#F8EEEB] py-[30px] 2usm:px-5 px-11">
            <div className="mb-[30px]">
              ...
              <span className="text-[#07051E] min-w-[300px] w-1/2 font-[400] block text-[15px] mb-4">
                Clover Suite is revolutionizing communication for DAO operators.
                But we can&rsquo;t do it alone. We need your support to take our
            ...
            <div className="grid grid-cols-2 gap-4 st:grid-cols-1">
              <div className="bg-white p-6 item w-full min-w-[300px]">
                ...
                <span className="text-[#121212] font-[400] block text-[15px] mb-4">
                  Cultivate a vibrant and engaged community within your DAO with
                  our community-building tools
                </span>
            ...
            <div className="bg-[#201f25] rounded-[6px] w-full items-center justify-between flex p-10">
              <div className="w-1/2 sst:w-full flex items-start h-full justify-evenly flex-col">
                ...
                <p className="text-white text-[17px] block mb-5">
                  ...
                  operators. But we can&rsquo;t do it alone. We need your
                  support to take our innovative product to the next level.
                </p>
          ...
          <section className="px-11 bg-[#F6F7F8] 2usm:px-5 py-[30px]">
            ...
            <div className="grid grid-cols-2 gap-4 st:grid-cols-1">
              ...
              <div className="bg-[#efe6fc] rounded-[9px] p-7 item w-full min-w-[300px]">
                ...
                <span className="text-[#121212] font-[400] block text-[15px] mb-4">
                  ...
                  interactions. You would utilize clover to communicate with
                  other members, stay informed about DAO activities, and
            ...
            <div className="w-full bg-[#f8f6f2] rounded-[9px] p-7 mt-3 flex justify-center st:flex-col-reverse items-start">
              ...
              <div className="w-[45%] st:w-full">
                ...
                <span className="text-[#121212] font-[400] block text-[15px] mb-4">
                  You contribute resources, expertise, or funding to DAOs. You
                  may useclover to communicate with DAO operators and other
                  contributors, discuss project proposals, and stay updated on
                  the progress and outcomes of the DAO.
                </span>
              </div>
            </div>
          </section>
